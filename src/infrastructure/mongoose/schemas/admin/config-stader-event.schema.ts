...
export type ConfigStaderLiquidStakingEventDocument = ConfigStaderLiquidStakingEvent & Document;
class Fraction{
  @Prop({required:true})
  numerator:number;
  @Prop({required:true})
...
export const ConfigStaderLiquidStakingEventSchema = SchemaFactory.createForClass(ConfigStaderLiquidStakingEvent); 