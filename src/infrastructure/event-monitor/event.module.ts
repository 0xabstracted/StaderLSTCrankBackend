...
import { 
  AddValidatorEvent, AddValidatorEventSchema, 
  AddLiquidityEvent, AddLiquidityEventSchema,
  ChangeAuthorityEvent, ChangeAuthorityEventSchema, 
  ConfigLpEvent, ConfigLpEventSchema, 
  ConfigStaderLiquidStakingEvent, ConfigStaderLiquidStakingEventSchema,
  ClaimEvent, ClaimEventSchema,
  DeactivateStakeEvent, DeactivateStakeEventSchema, 
  DepositEvent, DepositEventSchema,
  DepositStakeAccountEvent, DepositStakeAccountEventSchema,
  EmergencyPauseEvent, EmergencyPauseEventSchema, 
  InitializeEvent, InitializeEventSchema,
  LiquidUnstakeEvent, LiquidUnstakeEventSchema,
  MergeStakesEvent, MergeStakesEventSchema,
  OrderUnstakeEvent, OrderUnstakeEventSchema,
  ReallocStakeListEvent, ReallocStakeListEventSchema,
  ReallocValidatorListEvent, ReallocValidatorListEventSchema,
  ResumeEvent, ResumeEventSchema,
  RedelegateEvent, RedelegateEventSchema, 
  StakeReserveEvent,StakeReserveEventSchema, 
  UpdateActiveEvent,UpdateActiveEventSchema, 
  UpdateDeactivatedEvent, UpdateDeactivatedEventSchema,
  RemoveLiquidityEvent, RemoveLiquidityEventSchema, 
  WithdrawStakeAccountEvent, WithdrawStakeAccountEventSchema,
} from '../mongoose/schemas';
import { RemoveValidatorEvent,RemoveValidatorEventSchema } from '../mongoose/schemas';
import { SetValidatorScoreEventSchema,SetValidatorScoreEvent } from '../mongoose/schemas';
...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      { name: SetValidatorScoreEvent.name, schema: SetValidatorScoreEventSchema },
      {name:ChangeAuthorityEvent.name,schema:ChangeAuthorityEventSchema},
      {name:ConfigLpEvent.name,schema:ConfigLpEventSchema},
      {name:ConfigStaderLiquidStakingEvent.name,schema:ConfigStaderLiquidStakingEventSchema},
      ...
      {name:ReallocValidatorListEvent.name,schema:ReallocValidatorListEventSchema},
      ...
      {name:UpdateDeactivatedEvent.name,schema:UpdateDeactivatedEventSchema},
      ...
      {name:DepositStakeAccountEvent.name,schema:DepositStakeAccountEventSchema},
      {name:WithdrawStakeAccountEvent.name,schema:WithdrawStakeAccountEventSchema}
    ]),
    ValidatorsModule,
